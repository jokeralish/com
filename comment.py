...
acil = PRANKBOTS.LINE() 
acil.login(token="EuSOYDL1Zw6fVmmqTBw6.6xds1P2JXWng1iIhqP06zG.OLFV5r/4R9t6w5F55OVtT92Bgjy4C2p4p4Ozax7TF6g=")
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="Eu9rBJ5MD4sGqEvR68Fc.Etxuxmj+g6ADI5iHaenl3a.OVwA6kKWXpFkyqWXB3cUT7wMMsQDVsEXExw9N/X0dPI=")
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="EuHn5SHumzUVdaoVvxtb.4ZBZ5hADtdWCWqwJrBfOMW.2D75KjozfbUyq7CkRXkrZ59lBePM4darqZV9AUcpofQ=")
pb2.loginResult()

pb3 = PRANKBOTS.LINE() 
pb3.login(token="EuIqDFOzJGjGvUSHthAe.gXfaDO+7YeX0muOGGVi7RG.3482wSj2oKwpzzXUwWAFsv0Z7xNqdU2HmqClb4u/GqM=")
pb3.loginResult()

pb4 = PRANKBOTS.LINE() 
pb4.login(token="EuQJK17xGz2wPlP6Jzk4.7QaKrsAwmAN6aJj9dZn51a.dc+v2wK3cu45BEX+7U1+NyTF9rwUcfZn790UFir9NN4=")
pb4.loginResult()

pb5 = PRANKBOTS.LINE() 
pb5.login(token="EupEx37WmtQxW8nzAGO7.is2rvSVZXBLpIOeEXj8hXW.JFjjC41GmNkvItgQAzeLP+00weR5kLAYmL3HsILwBXk=")
pb5.loginResult()

pb6 = PRANKBOTS.LINE() 
pb6.login(token="EumVkOEi1Izyq6EUY7p8.ShwDHg4FZ5FEA83YTUNtoa.yxFDfii8TPXxszpKGNMI9Cq8FRupiqWDwxPq6l4vZak=")
pb6.loginResult()

pb7 = PRANKBOTS.LINE() 
pb7.login(token="Eurnb3bSVOStnT3nfowc.eVcS/IFZ1si/UjBGpm1zpa.B6zNs/okPQX1bAqU/A8moqhvT1Zl0+TY5+btupuYDns=")
pb7.loginResult()

pb8 = PRANKBOTS.LINE() 
pb8.login(token="EuHaipwmhSNf0veJ6pnf.V0IUVRbU87/6l5rn/PupJW.rVb/QUqjgaMXU6CYPnTYGC66pl/P8NBZxzaXku+8mmE=")
pb8.loginResult()

pb9 = PRANKBOTS.LINE() 
pb9.login(token="Euq5Tjv5m2csmM3cmcG3.ZdkdutG52I9BtUwGVwxsWW.3QFeWCsJEgWSk/9fZaD4WHZOoHsHbnPMLuxnJhATPAU=")
pb9.loginResult()

pb10 = PRANKBOTS.LINE() 
pb10.login(token="EurpldHNk6lFoIYxcMg7.L7dLvB/ZHa/TQpeSloHWfW.ou8PkOC8iz0OJNRqD/+90ZHt46IE08aDOjr1v2k5Ah0=")
pb10.loginResult()
...
admsa = "u477d29ccf1f0a4f39117682207846b05"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""خوش اومدی به ربات اتو لایک line.me/ti/p/~joker.alish """,
    "lang":"JP",
    "comment1":"com by alish joker",
...
def bot(op):
   ...
   #             acil.like(url[25:58], url[66:], likeType=1001)
    ...
    #            pb3.like(url[25:58], url[66:], likeType=1001)
     #           pb4.like(url[25:58], url[66:], likeType=1001)
  #              pb5.like(url[25:58], url[66:], likeType=1001)
    #            pb6.like(url[25:58], url[66:], likeType=1001)
     #           pb7.like(url[25:58], url[66:], likeType=1001)
     #           pb8.like(url[25:58], url[66:], likeType=1001)
 #               pb9.like(url[25:58], url[66:], likeType=1001)
   #             pb10.like(url[25:58], url[66:], likeType=1001)
    #            pb11.like(url[25:58], url[66:], likeType=1001)
   #             pb12.like(url[25:58], url[66:], likeType=1001)
     #           pb13.like(url[25:58], url[66:], likeType=1001)
                ...
                pb2.comment(url[25:58], url[66:], wait["comment1"])
                pb2.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb3.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb4.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb5.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb6.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb7.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb8.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                ...
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb9.comment(url[25:58], url[66:], wait["comment1"])
                pb10.comment(url[25:58], url[66:], wait["comment1"])
                pb10.comment(url[25:58], url[66:], wait["comment1"])
                pb10.comment(url[25:58], url[66:], wait["comment1"])
                pb10.comment(url[25:58], url[66:], wait["comment1"])
                pb10.comment(url[25:58], url[66:], wait["comment1"])
